...
class App extends Component{
  ...
  componentDidMount(){
    axios.get('https://alexanderapi.herokuapp.com/series/')
    .then(res =>{
  ...
  mostrar(cod,index){
    axios.get('https://alexanderapi.herokuapp.com/series/'+cod)
    .then(res => {
      this.setState({
        pos: index,
        titulo: 'Editar',
  ...
  guardar(e){
    ...
    if(cod>0){
      ...
      axios.put('https://alexanderapi.herokuapp.com/series/'+cod,datos)
      .then(res =>{
      ...
      //nuevo registro
      axios.post('https://alexanderapi.herokuapp.com/series/',datos)
      .then(res => {
  ...
  eliminar(cod){
    ...
    if(rpta){
      axios.delete('https://alexanderapi.herokuapp.com/series/'+cod)
      .then(res =>{
                    ...
                    <tr key={serie.id}>
                      ...
                      <td>
                        <div class="d-grid gap-2 d-md-flex">
                          <Button type="button" variant="success" onClick={()=>this.mostrar(serie.id,index)}>Editar</Button>
                          <Button type="button" variant="danger" onClick={()=>this.eliminar(serie.id)}>Eliminar</Button>
                        </div>
                      </td>
                    </tr>
                  );
